...
def update_dataset(pkg_dict):
    ...
    # Create Package
    try:
        package = ckan.action.package_patch(id=pkg_name, title=pkg_dict['tender/title'],
                    ...
                    tender_documents_id=pkg_dict['tender/documents/id'], 
                    buyer_name=pkg_dict['buyer/name'],)
